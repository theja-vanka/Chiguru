...
export default class Dance1 extends Component {
...
<Text style={styles.points}>Obscenity of any kind will lead to disqualification  </Text>
<Text style={styles.points}>Minimum of four styles is mandatory and one Indian style is mandatory</Text>
