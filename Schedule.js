...
export default class Schedule extends Component {
  ...
  render() {
    const list = [
  {
    name: '09:00 AM - 11:30 AM',
    subtitle: 'Inauguration',
    icon: 'event',
    ricon: 'account-balance',
    },
  {
    name: '11:30 AM - 01:30 PM',
    subtitle: 'Mime',
    icon: 'event',
    ricon: 'phone',
  ...
  {
    name: '01:30 PM - 02:30 PM',
    subtitle: 'Stunt Show',
    icon: 'event',
    ricon: 'motorcycle',
    },
  {
    name: '02:30 PM - 04:30 PM',
...
const list2 = [
  ...
  {
    name: '05:00 PM - 09:00 PM',
    subtitle: 'Live Concert (AGAM)',
    icon: 'event',
    ricon: 'live-tv',
  },
  {
    name: '09:00 PM - 10:30 PM',
    subtitle: 'DJ Night',
    icon: 'event',
    ricon: 'adjust',
  },
