...
export default class Sport9 extends Component {
...
<Text style={styles.points}>Best of three</Text>
<Text style={styles.points}>Time limit (3+3+4) 10mins </Text>
<Text style={styles.points}>Registration fee: Rs.100</Text>
<Text style={styles.points}> Prize money: Winners: Rs.1500 Runners: Rs.700</Text> 
