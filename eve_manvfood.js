...
export default class Ent3 extends Component {
...
<Text style={styles.points}>No of Rounds: 3 </Text>
<Text style={styles.points}>Rules for the rounds will be conveyed at the venue </Text>
<Text style={styles.points}>Registration fee: Rs.200 </Text>
<Text style={styles.points}>Prize Money:  Winner: Rs.2000 Runners:Rs.1000</Text>
          </View>
    )
  }
  componentDidMount() {
