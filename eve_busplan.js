...
<Text style={styles.points}>2 Members in a team</Text>
<Text style={styles.points}>PPT Presentation is Compulsory </Text>
<Text style={styles.points}>2 Hard copies of the plan need to be submitted during Registration </Text>
