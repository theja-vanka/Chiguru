...
export default class Sport5 extends Component {
...
<Text style={styles.points}>3 members per team</Text>
<Text style={styles.points}>Time limit: 120 minutes</Text>
<Text style={styles.points}>Registration fee: Rs.150</Text>
