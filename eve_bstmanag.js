...
export default class Business1 extends Component {
...
<Text style={styles.points}>Two copies of resume should be provided to                           event coordinators  </Text>
<Text style={styles.points}>Registration fee: Rs.100</Text>
<Text style={styles.points}>Prize money: Winners: Rs.2500 </Text>
</View>
    )
  }
  componentDidMount() {
